-- discord.gg/DUYBOYroblox


shared.LoaderTitle = "CAO KHÁNH DUY Roblox";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://13532107100426",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=13532107100426";
v24.Parent = v23;
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://13532107100426") then
                    return v729;
                end
            end
        end
